...
<head>
  ...
  <title>Invoice Sale -{{ $invoice->first()->Invoice->invoice_number }}</title>
                ...
                <div class="cs-mb50">
                  <div class="cs-text_right">
                    ...
                    <p class="cs-m0" style="font-weight: 500;">
                      {{ $invoice->first()->first()->salesOrder->status =='Completed' ? 'PAID' :'UNPAID' }}
                      <br><br><br><br>
                    </p>
                  </div>
                  <div class="cs-invoice_left">
                    ...
                    <p>
                      ...
                      {{ $invoice->first()->first()->customer->city }} <br>
                    </p>
                  </div>
                </div>
                    ...
                    <div class="cs-table_responsive">
                      <table class="cs-mb30">
                        ...
                        <tbody>
                          ...
                          @foreach ($invoiceSale as $invoices)
                          <tr class="border-bottom-1">
                            <td class="cs-width_5 cs-primary_color cs-f15">
                              {{$invoices->product->name}}
                            </td>
                            <td class="cs-width_2 cs-primary_color cs-f15">$
                              {{number_format($invoices->price_per_unit,0)}}</td>
                            <td class="cs-width_2 cs-primary_color cs-f15">{{$invoices->quantity}}</td>
                            <td class="cs-width_2 cs-text_right cs-primary_color cs-f15">
                              ${{number_format($invoices->total_amount,0)}}</td>
                          </tr>
                          @endforeach
                ...
                <div class="display-flex space-between mq-align-items">
                  ...
                  <div class="cs-width_4">
                    <p class="cs-secondary_color cs-text_right cs-f15">Total : <span
                        class="cs-ml30 cs-primary_color cs-semi_bold">${{number_format($invoices->invoice->total_amount,0)}}</span>
                    </p>
                  ...
                  <div class="display-flex justify-content-flex-end">
                    <div class="cs-text_right">
                      <b class="cs-primary_color">
                        @if ($invoice->first()->first()->salesOrder->status == 'Completed')
