    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <form id="form-data" method="POST" action="{{ route('updatecustomer') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-8 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control type="text"
                                    value="{{ $customers->customer_name }}" id="customer_name" name="customer_name"
                                    autofocus />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-8 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email"
                                    value="{{ $customers->email }}" id="emailCustomer" name="emailCustomer"
                        ...
                        <div class="col-lg-4 col-sm-8 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control "
                                    value="{{ $customers->phone }}" type="text" id="phone" name="phone"
                        ...
                        <div class="col-lg-4 col-sm-8 col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select " id="city"
                                    ...
                                    <option value="sulaymaniyah" {{ $customers->city =='sulaymaniyah' ? 'selected' : '' }}>Sulaymaniyah
                                    </option>
                                    <option value="hawler" {{ $customers->city =='hawler' ? 'selected' : '' }}>Hawler
                                    </option>
                                    <option value="halabja" {{ $customers->city =='halabja' ? 'selected' : '' }}>Halabja
                                    </option>
                                    <option value="Duhok" {{ $customers->city =='Duhok' ? 'selected' : '' }}>Duhok
                                    </option>
                        ...
                        <div class="col-lg-4 col-sm-8 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control " type="text"
                                    value="{{ $customers->district }}" id="district" name="district" autofocus />
                        ...
                        <div class="col-lg-4 col-sm-8 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text"
                                    value="{{ $customers->address }}" id="address" name="address" autofocus />
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="descriptionCustomer" name="description"
                                    class="form-control ">{{ $customers->description }}</textarea>
                                    ...
                                    <li>
                                        <div class="productviews" style="width: 250px">
                                            <div class="productviewsimg">
                                                <img src="{{ asset('uploads/product/customers/' . $customers->avatar) }}"
                                                    alt="img" id="productImage">

                                            </div>
                                            <div class="productviewscontent">
                                                <div class="productviewsname">
                                                    <h2 id="imageName">{{ $customers->avatar }}</h2>
                                                    <h3 id="imageSize">
                                                        {{ formatBytes(filesize(public_path($customers->image_path))) }}
                                                    </h3>
