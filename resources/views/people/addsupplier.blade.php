...
@section('content')
    ...
    <div class="page-wrapper page-wrapper-one">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('addsupplier.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-8 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control " type="text" value="{{ old('supplier_name') }}"
                            ...
                            <div class="col-lg-4 col-sm-8 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control " type="email" value="{{ old('email') }}" id="emailSupplier"
                                        name="email" />
                            ...
                            <div class="col-lg-4 col-sm-8 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control " type="text" value="{{ old('district') }}" id="district"
                            ...
                            <div class="col-lg-4 col-sm-8 col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control " type="text" value="{{ old('address') }}" id="address"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="descriptionSupplier" name="description" class="form-control ">{{ old('description') }}</textarea>
