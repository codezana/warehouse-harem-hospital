...
@section('content')
    ...
    <div class="page-wrapper page-wrapper-one">
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('addbrand.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="name">Brand Name</label>
                                    <input type="text" value="{{ old('name') }}" id="nameBrand" name="name"
                                        class="form-control ">
                                </div>
                            </div>
...
@section('custom-js')
    ...
    <script>
        ...
        console.log(productviewsimg);
console.log(productviewsdiv);
console.log(deletingImage);console.log(fileInput);
