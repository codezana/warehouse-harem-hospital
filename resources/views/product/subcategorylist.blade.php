        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h6>View/Search product SubCategory</h6>
                </div>
                <div class="page-btn">
                    @if ($showAddColumn)
                        <a href="{{ route('subcategorypage') }}" class="btn btn-added">
                                ...
                                @foreach ($subcategorys as $subcategory)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if(isset($subcategory->subcategory_image))
                                        ...
                                        <td class="descriptions">{{ $subcategory->description }}</td>
                                        <td>{{ $subcategory->user ? $subcategory->user->username : 'N/A' }}</td>
                                            ...
                                            <td>
                                                ...
                                                @if ($showEditColumn)
                                                    <a class="edit-user me-3"
                                                        href="{{ route('product.subcategory.edit', ['id' => $subcategory->id]) }}">
                                                ...
                                                @if ($showDeleteColumn)
                                                    <form action="{{ route('subcategory.delete', ['id' => $subcategory->id]) }}"
                                                        style="display: inline" method="POST" class="delete-form">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a class="me-3 delete-button" href="javascript:void(0);"
                                                            data-user-id="{{ $subcategory->id }}">
                                                            <img src="assets/img/icons/delete.svg" alt="img">
                                                        </a>

                                                        <div id="deleteModal{{ $subcategory->id }}" class="modal">
                                                            <div class="modal-content">
                                                                ...
                                                                <button id="confirmDelete" class="confirmDelete noselect"
                                                                    data-user-id="{{ $subcategory->id }}"><span
                                                                        class="text">Yes,
                                    ...
                                    <div id="modal-{{ $loop->index }}" class="modal">
                                        <div class="modal-content">
                                            ...
                                            <p class="full-description">{{ $subcategory->description }}</p>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <script>
                                    $(document).ready(function() {
                                        $('.delete-button').click(function() {
                                            var subcategoryId = $(this).data('user-id'); 
                                            
                                            $('#deleteModal' + subcategoryId).show();
                                        });
                                        ...
                                        $('.confirmDelete').click(function(event) {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    ...
                                                    $('#deleteModal' + subcategoryId).hide();
                                                    setTimeout(function() {
