...
@section('content')
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Enter id" id="unitid">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Enter Unit Name" id="unitname">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 col-12">
                                    <div class="form-group">
                                        <input type="text" placeholder="Enter Unit code" id="unitcode">
                                    </div>
                                </div>
                                ...
                                @foreach ($types as $index => $type)
                                    <tr>
                                        ...
                                        <td class="description-cell" id="description-cell-{{ $loop->index }}">
                                            <span
                                                class="truncated-description">{{ Str::limit($type->description, 25) }}</span>
                                            @if (strlen($type->description) > 25)
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);" class="dropdown-item"
                                                        ...
                                                        data-bs-target="#createpayment{{ $type->id }}"><img
                                                ...
                                                <li>
                                                    <a href="javascript:void(0);"
                                                        action="{{ route('unit.delete', ['id' => $type->id]) }}"
                                                        data-user-id="{{ $type->id }}"
                                    ...
                                    <!-- Delete type Modal -->
                                    <div id="deleteModal{{ $type->id }}" class="modal">
                                        <div class="modal-content">
                                            <span class="close">&times;</span>
                                            <h2>Confirm Deletion</h2>
                                            <form id="deleteForm{{ $type->id }}"
                                                action="{{ route('unit.delete', ['id' => $type->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')

                                                <p>Are you sure you want to {{ $type->type_name }} delete this item?</p>
                                    ...
                                    <div class="modal fade" id="createpayment{{ $type->id }}" tabindex="-1"
                                        aria-labelledby="createpayment{{ $type->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <form id="form-data" method="POST" action="{{ route('unit.update') }}">
                                                    @csrf
                                                    ...
                                                    <div class="modal-footer">
                                                        <button id="submitBtnUnit" type="submit"
    ...
    <script>
        $(document).ready(function() {
            $('#submitBtnUnit').click(function(e) {
                e.preventDefault(); // Prevent form from submitting normally

                var id = $('#id').val();
                var UnitName = $('#type_name').val();

                // Get the value of the textarea for Unit description
                var UnitDescription = $('#description').val();
                ...
                formData.append('description', UnitDescription);
...
@section('custom-js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#unitid, #unitname, #unitcode").on("keyup change",
                function() {
                    const unitid = $("#unitid").val().toLowerCase();
                    const unitname = $("#unitname").val().toLowerCase();
                    const unitcode = $("#unitcode").val().toLowerCase();
            ...
            clearButton.on("click", function() {
                $("#unitid, #unitname, #unitcode").val(""); // Clear input values
