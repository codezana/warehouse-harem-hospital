...
<head>
    <title>Advanced Report-Purchase</title>
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="item-desc-1">
                                                        <span>{{ $filteredPurchase->product->name }}</span>
                                                    </div>
                                                </td>
                                                <td class="text-center">{{ number_format($filteredPurchase->purchase_price,0) }}</td>
                                                <td class="text-center">{{ $filteredPurchase->quantity }}</td>
                                                <td class="text-center">
                                                    {{ number_format($filteredPurchase->quantity*$filteredPurchase->purchase_price,0) }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right fw-bold">{{ $filteredPurchases->sum(function ($purchase) {
                                                return $purchase->totalPurchase->grand_total;
                                            }) }}</td>                                        </tr>
                                    </tbody>
                                </table>
                            </div>
