            ...
            <div class="card">
                <div class="card-body">
                    <div class="row" style="position: relative">
                        <form action="{{ route('update.sale.page') }}" method="POST">
                            <div class="row">
                                ...
                                <input type="text" style="display: none" name="sale_order_id" id="sale_order_id"
                                    value="{{ $salesOrderId }}">
                                <input type="text" style="display: none" name="" id="receipt_sale"
                                    value="{{ $receipt }}">
                                <input type="text" style="display: none" name="" id="date_sale"
                                    value="{{ $date }}">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="{{ route('saleslist.page') }}" class="btn btn-cancel" id="cancel-button">Cancel</a>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#submit-button').click(function(event) {
                ...
                var salesOrderIds = document.getElementById("sale_order_id").value;
