        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Add Sale Return</h4>
                    <h6>Manage your sale return 🚛</h6>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-lg-2 col-sm-2 col-2 ps-0">
                        ...
                        {{-- <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                <label>Resicpt</label>
                                <div class="input-groupicon">
                                    <input class="Resicpt" type="text" name="resicpt" placeholder="Please Enter A vaild Resicpt">
                                                    ...
                                                    <div class="col-lg-6 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                id="customer_name" name="customer_name" autofocus />
                                                            @error('customer_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                                ...
                                                                <li>
                                                                    <div class="productviews" style="width: 250px">
                                                                        ...
                                                                        <div class="productviewscontent">
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                                class="hidesets" id="hidesets">x</a>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
                        ...
                        <form action="{{ route('store_sales') }}" method="POST">
                            ...
                            <div class="col-lg-12">
                                ...
                                <a href="{{ route('salesreturnlist.page') }}" id="cancel-button" class="btn btn-cancel">Cancel</a>
                            </div>
        ...
        $(document).ready(function() {
            $('#submit-button').click(function(event) {
                ...
                $('#item-table tbody tr').each(function() {
                    ...
                    // console.log('Quantity:', rowData.product_id);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Toastify({
                            text: 'Sale Return stored successfully!!',
                            duration: 2000,
                            gravity: 'top-left', // Position the toast notification at the top left corner
                            close: true, // Show a close button
                            backgroundColor: 'linear-gradient(to right, #118251, #16342a)', // Custom background color
