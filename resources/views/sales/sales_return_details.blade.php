...
@section('name', 'Sales Return Details')
@section('custom-css')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-sales-split">
                        <h2>Sale Return Detail : {{ $sales_return->first()->first()->receipt }}</h2>
                        <ul>
                            <li>
                                ...
                                <tr class="top">
                                    ...
                                    <td
                                        ...
                                        <font style="vertical-align: inherit;">
                                            <font
                                                style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                {{ $sales_return->first()->first()->receipt }} </font>
                                        </font><br>
                                        <font style="vertical-align: inherit;">
                                            <font
    ...
    <div class="col-lg-6 ">
        <div class="total-order w-100 max-widthauto m-auto mb-4">
            <ul>
                <li>
                    <h4>Shipping</h4>
                    <h5>${{ number_format($sales_return->first()->first()->salesOrder->shipping, 2) }}
                    </h5>
                </li>
                <li class="total">
                    <h4>Grand Total</h4>
