...
{ //Update Premission 
    ...
    public function editPremission(Permission $permission, Request $request)
    {
        ...
        return view('Settings.editpermission', compact(
            'productPermissions',
            'salesPermissions',
            'posPermissions',
            'requestPermissions',
    ...
    public function updatePremission(Request $request)
    {
        ...
        // Update role role name and description

        $role->save();

        // Get an array of permissions from the request
        ...
        return response()->json(['message' => 'Role and Primission Updated successfully']);
    }
}
